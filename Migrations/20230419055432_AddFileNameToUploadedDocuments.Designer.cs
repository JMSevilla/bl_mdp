...
namespace WTW.MdpService.Migrations
{
    ...
    [Migration("20230419055432_AddFileNameToUploadedDocuments")]
    partial class AddFileNameToUploadedDocuments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.TransferJourneyDocument", b =>
                {
                    b.Property<long>("TransferJourneyId")
                        .HasColumnType("bigint");

                    b.Property<long>("UploadedDocumentId")
                        .HasColumnType("bigint");

                    b.HasKey("TransferJourneyId");

                    b.HasIndex("UploadedDocumentId");

                    b.ToTable("TransferJourneyDocument", (string)null);
                });
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.TransferJourneyDocument", b =>
                {
                    ...
                    b.HasOne("WTW.MdpService.Domain.Common.UploadedDocument", "Document")
                        .WithMany()
