...
namespace WTW.MdpService.Migrations
{
    ...
    [Migration("20221221092516_AddExpiryDateFieldToBereavementJourney")]
    partial class AddExpiryDateFieldToBereavementJourney
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.BereavementContactConfirmation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.Journeys.BereavementJourney", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.Journeys.JourneyBranch", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.Journeys.JourneyStep", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.Journeys.QuestionForm", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.Journeys.QuoteSelectionJourney", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.Journeys.RetirementJourney", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.Journeys.TransferJourney", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.Calculations.Calculation", b =>
                {
                    b.HasOne("WTW.MdpService.Domain.Mdp.Journeys.RetirementJourney", "RetirementJourney")
                        .WithOne("Calculation")
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.Journeys.JourneyBranch", b =>
                {
                    b.HasOne("WTW.MdpService.Domain.Mdp.Journeys.BereavementJourney", null)
                        .WithMany("JourneyBranches")
                        .HasForeignKey("BereavementJourneyId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("WTW.MdpService.Domain.Mdp.Journeys.QuoteSelectionJourney", null)
                        .WithMany("JourneyBranches")
                        .HasForeignKey("QuoteSelectionJourneyId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("WTW.MdpService.Domain.Mdp.Journeys.RetirementJourney", null)
                        .WithMany("JourneyBranches")
                        .HasForeignKey("RetirementJourneyId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("WTW.MdpService.Domain.Mdp.Journeys.TransferJourney", null)
                        .WithMany("JourneyBranches")
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.Journeys.JourneyStep", b =>
                {
                    b.HasOne("WTW.MdpService.Domain.Mdp.Journeys.JourneyBranch", null)
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.Journeys.QuestionForm", b =>
                {
                    b.HasOne("WTW.MdpService.Domain.Mdp.Journeys.JourneyStep", null)
                        .WithOne("QuestionForm")
                        .HasForeignKey("WTW.MdpService.Domain.Mdp.Journeys.QuestionForm", "JourneyStepId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
