...
namespace WTW.MdpService.Migrations
{
    ...
    [Migration("20220505105252_MakeIdentityDocumentFileNameNullable")]
    partial class MakeIdentityDocumentFileNameNullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.LifetimeAllowance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("LifetimeAllowance", (string)null);
                });
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.RetirementPostIndexEvent", b =>
                {
                    ...
                    b.Property<int?>("IdentityDocumentImageId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.LifetimeAllowance", b =>
                {
                    b.HasOne("WTW.MdpService.Domain.Mdp.JourneyStep", null)
                        .WithOne("LifetimeAllowance")
                        .HasForeignKey("WTW.MdpService.Domain.Mdp.LifetimeAllowance", "JourneyStepId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WTW.MdpService.Domain.Mdp.JourneyStep", b =>
                {
                    b.Navigation("LifetimeAllowance");
