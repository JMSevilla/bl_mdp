...
public record BankAccountResponseV2
{
    ...
    public string BankAccountCurrency { get; init; }
    public static BankAccountResponseV2 From(BankAccount account)
    {
        return new()
        {
            ...
            BankAccountCurrency = account.Bank.AccountCurrency,
        };
    }
}